...
export default function MyFixedNav() {
  ...
  return (
    <>
      <Navbar expand="lg" fixed={"top"} className={`fixedNav ${isFixedOnPage ? "navTransformationDown" : "navTransformationTop"}`}>
        <Container>
          ...
          <NavLink className={`nav-link me-4 cartLink fs-3 cartResponsiveContent d-none ${!isAuth && "mx-auto"}`} to="/cart" onClick={()=> scrollingToTop()} >
